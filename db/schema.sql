...
CREATE INDEX FK_108 ON gowebapp.sets ( Exercise_ID );
...
(
    ...
    CONSTRAINT FK_74 FOREIGN KEY ( User_ID ) REFERENCES gowebapp.users
);

CREATE INDEX FK_73 ON gowebapp.workouts ( Set_ID, Exercise_ID );
